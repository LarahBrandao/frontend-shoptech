...
const stripePromise = loadStripe("pk_test_51M3hs8LuYKaT3a6I8UwGIXbhn5YNwed02ZPMeFtvpkkwGaroxnrO5iFr126zHGUZQaZ0nmbC0En3P3dPZ9fVRVPd00WrBW2zKF");
        ...
        <Container style={{ minHeight: "95vh" }} className="cart-container">
            <Row>
                <Col>
                    ...
                    {cart.length === 0 ? (
                        <Alert variant="info">O seu carrinho de compras está vazio. Adicione seus produtos.</Alert>
                    ) : (
                ...
                {cart.length > 0 && (
                    <Col md={5}>
                        <>
                            ...
                            <div>
                                <h3 className="h4 pt-4">Total:{numberFormat(user.cart.total)}</h3>
                            </div>
                        </>
                    </Col>
                )}
