        ...
        <Container className="pt-4" style={{ position: "relative" }}>
            <Row>
                ...
                <Col lg={6} className="pt-4">
                    ...
                    <p className="product__price">{numberFormat(product.price)}</p>
                    ...
                    {isSuccess && <ToastMessage bg="info" title="Adicionado ao carrinho" body={`${product.name} foi adicionado ao seu carrinho`} />}
                </Col>
            </Row>
            <div className="my-4">
